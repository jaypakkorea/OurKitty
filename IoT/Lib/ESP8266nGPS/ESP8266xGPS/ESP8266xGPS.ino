...
const char *GScriptId = "AKfycbzPYL0WHGKzbYTIHRMmB1dnUBTDQ6TW3i5-wMU3NUlTYyh9t4wOkYgkIQ1iYyquEQ_i";
...
void loop() {
  ...
  latitude = random(0,1000);
  longitude = random(0,1000);
  speed = random(0,100000);
  ...
  payload = payload_base + "\"" + latitude + "," + longitude + "," + speed + "\"}";
